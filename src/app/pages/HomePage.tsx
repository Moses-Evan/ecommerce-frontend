...
import { Sparkles, ShieldCheck, TruckIcon, Headphones, ArrowRight, Star } from "lucide-react";
...
export function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Free Shipping",
      description: "Pan-India delivery on orders above ₹2999"
    },
    {
  ...
  return (
    <main>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <p className="text-secondary mb-2 tracking-widest uppercase">Explore</p>
            <h2 className="text-4xl md:text-5xl mb-4">Our Collections</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Discover our curated collections for every occasion, from grand weddings to everyday elegance
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <p className="text-secondary mb-2 tracking-widest uppercase">Bestsellers</p>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="p-12">
                <p className="text-secondary mb-2 tracking-widest uppercase">New Season</p>
                <h2 className="text-4xl md:text-5xl mb-4">Spring Collection 2025</h2>
                <p className="text-muted-foreground mb-6 text-lg">
                  Discover our latest collection featuring vibrant colors, exquisite craftsmanship, 
                  and contemporary designs perfect for the new season.
                </p>
                <Button onClick={() => navigate("category", { category: "all" })} size="lg">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <p className="text-secondary mb-2 tracking-widest uppercase">Perfect For Every Moment</p>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
                <div>
                  ...
                  <p className="text-white/80 text-sm">Timeless elegance for your big day</p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
                <div>
                  ...
                  <p className="text-white/80 text-sm">Celebrate in vibrant style</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-secondary mb-2 tracking-widest uppercase">Why Draupadi Vastralya</p>
              <h2 className="text-4xl mb-6">Crafted with Love, Delivered with Care</h2>
              <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                Each saree in our collection is handpicked from master weavers across India, 
                ensuring authenticity, quality, and timeless elegance. We celebrate India's 
                rich textile heritage while bringing you contemporary designs.
              </p>
              ...
              <Button onClick={() => navigate("about")} variant="outline" size="lg" className="mt-8">
                Learn Our Story
              </Button>
            </div>
